...
resource "azurerm_virtual_machine_extension" "cyclecloud_install" {
  name                 = "cyclecloud-install"
  ...
  settings = <<SETTINGS
    {
      "fileUris": ["https://<your-storage-url>/cyclecloud_install.py"],
      "commandToExecute": "python3 cyclecloud_install.py"
    }
SETTINGS
